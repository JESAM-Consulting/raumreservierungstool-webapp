    ...
    <div>
      <header>
        ...
        <div className='right-content'>
          ...
          <div className='mobile-menu' onClick={()=> setMobileheader(!mobileheader)}>
      ...
      </div>
      {
        mobileheader && (
          ...
          <div className='mobile-sidebar-wrapper'></div>
        )
      }
      <div className={mobileheader ? 'mobile-sidebar-design header-show' : 'mobile-sidebar-design header-hidden' }>
        <div className='m-header'>
          <img src={MobileLogo} alt="MobileLogo"/>
          <i onClick={()=> setMobileheader(false)} class="fa-solid fa-xmark"></i>
        </div>
